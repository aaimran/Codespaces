module RHS_Interior
  ...
  use common, only : wp
  use anelastic_point, only : apply_anelastic_Qf_point, apply_anelastic_Qf8_point, &
                              apply_const_Q_4M_point, apply_const_Q_8M_point
     ...
     subroutine apply_anelastic_Qf8_point_pml(B, M, G, x, y, z, Ux, Uy, Uz, DU)
          ...
          do i = 1, 8
               M%Deta4Qf8(x,y,z,i) = M%Deta4Qf8(x,y,z,i) + ( &
                    ( (M%weight_Qf8(i)*2.0_wp*M%M(x,y,z,2)*M%Qs_inv_Qf8(x,y,z))*exx &
               ...
               M%Deta5Qf8(x,y,z,i) = M%Deta5Qf8(x,y,z,i) + ( &
                    ( (M%weight_Qf8(i)*2.0_wp*M%M(x,y,z,2)*M%Qs_inv_Qf8(x,y,z))*eyy &
                    + (M%weight_Qf8(i) * ( (M%M(x,y,z,1)+2.0_wp*M%M(x,y,z,2))*M%Qp_inv_Qf8(x,y,z) &
                                                     - 2.0_wp*M%M(x,y,z,2)*M%Qs_inv_Qf8(x,y,z) ) * tr ) ) &
                    - M%eta5Qf8(x,y,z,i) ) / M%tau_Qf8(i)
               M%Deta6Qf8(x,y,z,i) = M%Deta6Qf8(x,y,z,i) + ( &
                    ( (M%weight_Qf8(i)*2.0_wp*M%M(x,y,z,2)*M%Qs_inv_Qf8(x,y,z))*ezz &
                    + (M%weight_Qf8(i) * ( (M%M(x,y,z,1)+2.0_wp*M%M(x,y,z,2))*M%Qp_inv_Qf8(x,y,z) &
                                                     - 2.0_wp*M%M(x,y,z,2)*M%Qs_inv_Qf8(x,y,z) ) * tr ) ) &
                    - M%eta6Qf8(x,y,z,i) ) / M%tau_Qf8(i)
               M%Deta7Qf8(x,y,z,i) = M%Deta7Qf8(x,y,z,i) + ( &
                    (M%weight_Qf8(i)*M%M(x,y,z,2)*M%Qs_inv_Qf8(x,y,z)*gxy - M%eta7Qf8(x,y,z,i)) / M%tau_Qf8(i) )
               M%Deta8Qf8(x,y,z,i) = M%Deta8Qf8(x,y,z,i) + ( &
                    (M%weight_Qf8(i)*M%M(x,y,z,2)*M%Qs_inv_Qf8(x,y,z)*gxz - M%eta8Qf8(x,y,z,i)) / M%tau_Qf8(i) )
               M%Deta9Qf8(x,y,z,i) = M%Deta9Qf8(x,y,z,i) + ( &
                    (M%weight_Qf8(i)*M%M(x,y,z,2)*M%Qs_inv_Qf8(x,y,z)*gyz - M%eta9Qf8(x,y,z,i)) / M%tau_Qf8(i) )
          end do
